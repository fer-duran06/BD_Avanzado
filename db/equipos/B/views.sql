-- ============================================================
-- ActividadViewsSQL - Equipo B
-- Archivo: db/equipos/B/views.sql
-- ============================================================
-- Reglas:
-- - No SELECT *
...
/*
VISTA 1: vw_top_productos_B
Que devuelve: TODO
Grain (una fila representa): TODO
Metricas: SUM(...), COUNT(...)
*/
CREATE OR REPLACE VIEW vw_top_productos_B AS
SELECT
    p.id AS producto_id,
...
WHERE MOD(od.producto_id, 6) = 1
GROUP BY p.id, p.nombre
HAVING SUM(od.cantidad) >= 1;

/*
VISTA 2: vw_ventas_mensuales_B
Que devuelve: TODO
Grain (una fila representa): TODO
Metricas: COUNT DISTINCT ordenes, SUM total
*/
CREATE OR REPLACE VIEW vw_ventas_mensuales_B AS
SELECT
...
/*
VISTA 3: vw_clientes_valor_B
Que devuelve: TODO
Grain (una fila representa): TODO
Metricas: COUNT DISTINCT ordenes, SUM total
*/
CREATE OR REPLACE VIEW vw_clientes_valor_B AS
SELECT
    u.id AS cliente_id,
