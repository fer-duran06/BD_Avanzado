-- ============================================================
-- ActividadViewsSQL - Equipo A
-- Archivo: db/equipos/A/views.sql
-- ============================================================
-- Reglas:
-- - No SELECT *
...
/*
VISTA 1: vw_top_productos_A
Que devuelve: TODO
Grain (una fila representa): TODO
Metricas: SUM(...), COUNT(...)
*/
CREATE OR REPLACE VIEW vw_top_productos_A AS
SELECT
    p.id AS producto_id,
...
WHERE MOD(od.producto_id, 6) = 0
GROUP BY p.id, p.nombre
HAVING SUM(od.cantidad) >= 1;

/*
VISTA 2: vw_ventas_mensuales_A
Que devuelve: TODO
Grain (una fila representa): TODO
Metricas: COUNT DISTINCT ordenes, SUM total
*/
CREATE OR REPLACE VIEW vw_ventas_mensuales_A AS
SELECT
...
/*
VISTA 3: vw_clientes_valor_A
Que devuelve: TODO
Grain (una fila representa): TODO
Metricas: COUNT DISTINCT ordenes, SUM total
*/
CREATE OR REPLACE VIEW vw_clientes_valor_A AS
SELECT
    u.id AS cliente_id,
